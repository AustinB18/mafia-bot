...
#  We will have to include oauth_helper.refresh() in the begining of our functions and have exceptions to refresh: except praw.errors.OAuthInvalidToken: oauth_helper.refresh()




print("logging in...\n")
r.login("MafiaBot", "dadmomsrule")
